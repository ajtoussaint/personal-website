...
export default function Bekenstein(props){
    return(
        <div className="pageWrapper">
            <a href="https://note-taking-app-jofz.onrender.com/profile">
                <img src={scrn} alt="Bekenstein Limit" className="projectImg"></img>
            </a>
            <div className='projectDescription'>
                <h3>Project Overview</h3>
                <p><a href="https://note-taking-app-jofz.onrender.com/profile">Bekenstein Limit</a> is a note taking app desgined to help the user organize their thoughts on various 
                subjects. Notes can be organized into folders and given tags. Filters can then be applied to easily find the note you are looking for. I was inspired to create 
